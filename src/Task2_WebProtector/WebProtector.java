...
public class WebProtector {
	...
	public void InvokeBrowser(@Optional("chrome") String browser) 
	{
		...
		{ 
			System.setProperty("webdriver.chrome.driver","C://Users//Amish//Desktop//eclipse-workspace//Task2//Drivers//chromedriver.exe");
			driver = new ChromeDriver();
		}
		else if (browser.equalsIgnoreCase("ie"))
		{
			System.setProperty("webdriver.ie.driver", "C://Users//Amish//Desktop//eclipse-workspace//Task2//Drivers//IEDriverServer.exe");
